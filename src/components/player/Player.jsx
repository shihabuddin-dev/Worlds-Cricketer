...
const Player = ({ player }) => {
    ...
    return (
        <div className='container mx-auto mt-4 px-2'>
            <div className='p-3 border-1 border-gray-400 rounded-lg space-y-2'>
                ...
                <div className='flex justify-between '>
                    ...
                    <button className='bg-gray-200 px-2 py-1 rounded-md'>{role}</button>
                </div>
                ...
                <div className='flex justify-between'>
                    ...
                    <button className='border-1 border-gray-300 px-2 py-1 rounded-md'>Chose Player</button>
                </div>
